...
namespace IFix
{
    ...
    public static class Configure
    {
        ...
        public static IEnumerable<MethodInfo> GetTagMethods(Type tagType, string searchAssembly)
        {
            ...
            //{
            //    var assembly = temp[i];
            //    if (!(assembly.ManifestModule is System.Reflection.Emit.ModuleBuilder) && (assembly.GetName().Name == searchAssembly))
            //    {
            //        var temp1 = assembly.GetTypes();
            //        for (int j = 0; j < temp1.Length; j++)
            //        {
            //            var temp2 = temp1[j].GetMethods(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public
            //            | BindingFlags.NonPublic);
            //            for (int m = 0; m < temp2.Length; m++)
            //            {
            //                if(temp2[m].IsDefined(tagType, false))
            //                {
