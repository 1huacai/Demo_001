    ...
    public class IFixEditor
    {
        ...
        public static void InjectAssembly(string assembly)
        {
            ...
            if (hasSomethingToDo)
            {
                ...
                var core_path = "./Assets/Resources/Plugins/IFix.Core.dll";
                var assembly_path = GetScriptAssembliesFolder(assembly)+ assembly + ".dll"; ;
        ...
        private static string GetScriptAssembliesFolder(string dllName)
        {
            //if (dllName=="Demo")
            //{
                return "./Assets/Resources/Plugins/";
           // }
            //else
        ...
        static void doBackup(string ts)
        {
            ...
            var scriptAssembliesDir = string.Format("./Library/{0}/", "ScriptAssemblies");
        ...
        public static void Compile(string compileArgFile)
        {
            ...
            //}
            UnityEngine.Debug.LogError(compileProcess.StandardError.ReadToEnd());
            UnityEngine.Debug.Log(compileProcess.StandardOutput.ReadToEnd());
        ...
        public static void GenPlatformPatch(Platform platform, string patchOutputDir,
            string corePath = "./Assets/Resources/Plugins/IFix.Core.dll")
        {
            ...
            foreach (var assembly in injectAssemblys)
            {
                GenPatch(assembly, string.Format("{0}/{1}.dll", outputDir, assembly), "./Assets/Resources/Plugins/IFix.Core.dll", string.Format("{0}{1}.patch.bytes", patchOutputDir, assembly));
            }
#else
        ...
        public static void GenPatch(string assembly, string assemblyCSharpPath
            ...
            string corePath = "./Assets/Resources/Plugins/IFix.Core.dll", string patchPath = "Assembly-CSharp.patch.bytes")
        {
        ...
        public static void Patch()
        {
            ...
            try
            {
                ...
                {
                    var assembly_path = GetScriptAssembliesFolder(assembly) + assembly+".dll";
                    GenPatch(assembly, assembly_path, "./Assets/Resources/Plugins/IFix.Core.dll",
                        string.Format("Assets/Resources/Inject/{0}.patch.bytes", assembly));
                }
            }
            catch (Exception e)
            {
