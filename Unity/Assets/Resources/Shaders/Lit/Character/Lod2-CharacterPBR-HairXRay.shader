...
Shader "YoukiaEngine/Lit/Character/Lod2-CharacterPBR-HairXRay" 
{
	Properties 
    { 
        ...
        _AnisoExpo_0 ("Anisotropy rang 0", Range(1, 100)) = 1
	...
	SubShader 
    {		
        Tags { "Queue"="AlphaTest-10" "RenderType" = "Opaque" "Reflection" = "RenderReflectionHair" "ShadowType" = "ST_Opaque" }
        ...
        Pass 
        {
			...
			CGPROGRAM
                ...
                FragmentOutput frag(v2f_forward i) 
                {
                    ...
                    half3 normal = 0;
                    half shadow = 0;
                    half4 col = frag_fwdColor(i, nv, normal, shadow);
	...
	FallBack "VertexLit"
    CustomEditor "Lod2CharacterPBRHairInspector"
}
