...
//Lod3 怪物PBR gpu动画-2bone
//@@@DynamicShaderInfoEnd
Shader "YoukiaEngine/Lit/Character/Lod3-CharacterPBR-monster-bump" 
{
	Properties 
    {
	...
	SubShader 
    {
		...
		Pass 
        {
			...
			CGPROGRAM
                ...
                #pragma fragment fragbase_monster_bump
	...
	FallBack "VertexLit"
    CustomEditor "Lod3CharacterPBRMonsterBumpInspector"
}
