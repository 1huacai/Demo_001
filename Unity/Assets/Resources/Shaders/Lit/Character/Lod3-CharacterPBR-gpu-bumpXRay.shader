...
//Lod3 基础PBR gpu动画-2bone XRay 程序脚本控制
//@@@DynamicShaderInfoEnd
Shader "YoukiaEngine/Lit/Character/Lod3-CharacterPBR-gpu-bumpXRay" 
{
	Properties 
    {
	...
	FallBack "VertexLit"
    CustomEditor "Lod3CharacterPBRGPUBumpInspector"
}
