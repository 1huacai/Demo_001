...
//不需要 CutOff 效果的材质请使用YoukiaPBR!!!
//@@@DynamicShaderInfoEnd
Shader "YoukiaEngine/Lit/YoukiaPBR-CutOff" 
{
	Properties 
    {
	...
	SubShader 
    {
		Tags { "Queue"="Geometry" "RenderType"="Opaque" "ShadowType" = "ST_PBRDetailCutOff" "Reflection" = "RenderReflectionOpaque" }
