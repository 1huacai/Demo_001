...
namespace FrameWork.GUI.AorUI.events
{
    ...
    /// </summary>
    public class AorUIEventListener : MonoSwitch, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler/*,IDragHandler */
    {
            ...
            if (_isDown)
            {
                ...
                if ((Vector2.Distance(_currentEventData.position, _currentEventData.pressPosition) > AorUIEventConfig.PosThreshold) || _isDraged)
                {
                    ...
                    if (Drag)
                    {
                        ...
                        {
                            _UIManager.AorUIInterfaceLogic.Receive_Drag(this.gameObject, _currentEventData);
                        }
                    }
                    else
                    {
                ...
                if (_downValue > AorUIEventConfig.LongPressTimeThreshold)
                {
                    if (!_isLongPressed)
                    {
                        _isLongPressed = true;
                        if ((Vector2.Distance(_currentEventData.position, _currentEventData.pressPosition) < AorUIEventConfig.PosThreshold))
                        {
                            //LongPress
                            if (LongPress)
                            {
                                if (onEventLongPress != null)
                                {
                                    onEventLongPress.Invoke(gameObject, _currentEventData);
                                }
                                if (_UIManager != null && _UIManager.AorUIInterfaceLogic != null)
                                {
                                    _UIManager.AorUIInterfaceLogic.Receive_LongPress(this.gameObject, _currentEventData);
                                }
                            }
                            else
                            {
                                passEventLongPress(_parentEventListener, _currentEventData);
                            }
                        }
                    }
                }
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            {
                passEventDown(_parentEventListener, eventData);
            }
        }
        /// <summary>
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            {
                passEventUp(_parentEventListener, eventData);
            }
            ...
            if (Vector2.Distance(eventData.position, eventData.pressPosition) > AorUIEventConfig.SwingThreshold && _downValue < AorUIEventConfig.SwingTimeThreshold)
            {
                ...
                {
                    passEventSwing(_parentEventListener, eventData);
                }
            }
        }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (_downValue < AorUIEventConfig.ClickDelay && Vector2.Distance(eventData.position, eventData.pressPosition) < AorUIEventConfig.PosThreshold)
            {
                ...
                {
                    passEventClick(_parentEventListener, eventData);
                }
            }
        }
        /// <summary>
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            {
                passEventOver(_parentEventListener, eventData);
            }
        }
        /// <summary>
        ...
        public void OnPointerExit(PointerEventData eventData)
        {
            ...
            {
                passEventOut(_parentEventListener, eventData);
            }
        }
        /*
        ...
        ///----------------------------------------------------- passEvent 事件传递 方法组;
        public void passEventClick(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Click)
        ...
        public void passEventLongPress(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.LongPress)
        ...
        public void passEventDown(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Down)
        ...
        public void passEventUp(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Up)
        ...
        public void passEventOver(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Over)
        ...
        public void passEventOut(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Out)
        ...
        public void passEventDrag(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Drag)
        ...
        public void passEventSwing(AorUIEventListener p, PointerEventData eventData)
        {
            if (p != null)
            {
                if (p.Swing)
