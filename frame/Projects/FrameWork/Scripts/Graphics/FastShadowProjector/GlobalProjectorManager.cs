...
namespace FrameWork.Graphics.FastShadowProjector
{
    ...
    public class GlobalProjectorManager : MonoBehaviour
    {
        ...
        public void LoadConfig()
        {
            ...
            //            Config.ZClipFar = 130;
            //            Config.ProjectionAngles = new Vector3(90, 0, 0);
            //            Config.ShadowResolution = GlobalProjectorManager.ShadowResolutions.Low_256;
            //            Config.ShadowType = GlobalProjectorManager.ShadowType.ModelProjection;
        ...
        public void Initialize()
        {
            ...
            _ProjectorMaterialShadow = new Material(ApplicationCore.Instance.GetConstShader("Fast Shadow Projector/Multiply"));
            _ProjectorMaterialShadowAlpha = new Material(ApplicationCore.Instance.GetConstShader("Fast Shadow Projector/MultiplyAlpha"));
            _ProjectorMaterialLight = new Material(ApplicationCore.Instance.GetConstShader("Fast Shadow Projector/Add"));

            _PreShadowMaterialAlpha = new Material(ApplicationCore.Instance.GetConstShader("Fast Shadow Projector/PreModelAlpha"));
            _PreShadowMaterial = new Material(ApplicationCore.Instance.GetConstShader("Fast Shadow Projector/PreModel"));
        ...
        void CheckTriggers(bool shadow)
        {
            ...
            {
                if (Physics.Raycast(new Ray(_ShadowTriggers[n].transform.position, SingletonManager.GetManager<GraphicsManager>().ShadowMgr.GlobalProjectionDir), out raycastHit))
                {
