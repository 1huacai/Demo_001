    ...
    public class ShadowProjector : MonoBehaviour, IProjector
    {
        ...
        public GlobalProjectorManager.ProjectionCulling GlobalShadowCullingMode
        {
            set
            {
                ...
                SingletonManager.GetManager<GraphicsManager>().ShadowMgr.GlobalShadowCullingMode = _GlobalShadowCullingMode;
        ...
        public float GlobalCutOffDistance
        {
            set
            {
                ...
                SingletonManager.GetManager<GraphicsManager>().ShadowMgr.GlobalCutOffDistance = _GlobalCutOffDistance;
