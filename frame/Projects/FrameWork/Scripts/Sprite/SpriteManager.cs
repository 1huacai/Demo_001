...
namespace FrameWork
{
    public class SpriteManager : MonoBehaviour
    {
        ...
        private class SpriteEntity
        {
            ...
            private readonly List<SpriteItem> _sprites = new List<SpriteItem>();
            ...
            public void Update(int camp = 0)
            {
                for (int i = 0; i < _sprites.Count; i++)
                {
                    Matrix4x4 worldMatrix = _sprites[i].m_Transform.localToWorldMatrix;
                    ...
                    {
                        //Vertices[i * 4] = worldMatrix.MultiplyPoint(_sprites[i].Vertices[3]);
                        //Vertices[i * 4 + 1] = worldMatrix.MultiplyPoint(_sprites[i].Vertices[2]);
                        //Vertices[i * 4 + 2] = worldMatrix.MultiplyPoint(_sprites[i].Vertices[1]);
                        //Vertices[i * 4 + 3] = worldMatrix.MultiplyPoint(_sprites[i].Vertices[0]);

                        //Colors[i * 4] = _sprites[i].Colors[3];
                        //Colors[i * 4 + 1] = _sprites[i].Colors[2];
                        //Colors[i * 4 + 2] = _sprites[i].Colors[1];
                        //Colors[i * 4 + 3] = _sprites[i].Colors[0];

                        //TexCoords[i * 4] = _sprites[i].TexCoords[3];
                        //TexCoords[i * 4 + 1] = _sprites[i].TexCoords[2];
                        //TexCoords[i * 4 + 2] = _sprites[i].TexCoords[1];
                        //TexCoords[i * 4 + 3] = _sprites[i].TexCoords[0];
            ...
            public void AddSprite(SpriteItem sprite)
            {
            ...
            public void RemoveSprite(SpriteItem sprite)
            {
        ...
        {
            get { return _instance ?? (_instance = new GameObject("YKSpriteManager").AddComponent<SpriteManager>()); }
        }
        ...
        protected void Update()
        {
            ...
            foreach (KeyValuePair<Material, SpriteEntity> pair in _entitys)
            {
                pair.Value.Update(Camp);
            }
        }
