...
namespace FrameWork.GUI.AorUI.effects
{
    ...
    public class OutLinePlus : BaseMeshEffect
    {
        ...
        public override void ModifyMesh(VertexHelper vh) {
            ...
            {
                if ((Vector2)vtb.uv0 == Vector2.zero)
                    continue;
                ...
                if (i % 4 == 3)
                {
                    ...
                    **/
                    ...
                    //put to org
                    Vector2 UVpos1 = (Vector2)vt0.uv0 - UVcenter;
                    Vector2 UVpos2 = (Vector2)vt1.uv0 - UVcenter;
                    Vector2 UVpos3 = (Vector2)vt2.uv0 - UVcenter;
                    Vector2 UVpos4 = (Vector2)vt3.uv0 - UVcenter;
